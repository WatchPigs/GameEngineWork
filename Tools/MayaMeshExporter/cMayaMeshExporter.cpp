...
//			fout << std::fixed;
				...
				"{" "\n";
			{
				...
				for (int i = 0; i < i_vertexArray.size(); i++)
				{
					...
					fout << "\t\t\t" << "Tangent = {" << i_vertexArray[i].vertex.tx << ", " << i_vertexArray[i].vertex.ty << ", " << i_vertexArray[i].vertex.tz << ",}," "\n";
					fout << "\t\t\t" << "Bitangent = {" << i_vertexArray[i].vertex.btx << ", " << i_vertexArray[i].vertex.bty << ", " << i_vertexArray[i].vertex.btz << ",}," "\n";
					fout << "\t\t\t" << "TexCoord = {" << i_vertexArray[i].vertex.u << ", " << i_vertexArray[i].vertex.v << ",}," "\n";
				...
				fout << "\t" << "indexData = " "\n"
					 << "\t" << "{" "\n";
				fout << "\t\t";
				for (int i3 = 0; i3 < (i_indexArray.size() / 3); i3++)
				{
					fout << i_indexArray[i3 * 3] << ", " << i_indexArray[i3 * 3 + 2] << ", " << i_indexArray[i3 * 3 + 1];
					if (i3 >= i_indexArray.size() / 3 - 1) fout << "," "\n";
					else fout << ", ";
				}
				fout << "\t" << "}," "\n";
			}
