...
void eae6320::Graphics::cRenderTarget::ClearBuffer(float* i_clearColor)
{
	...
	// by "clearing" the image buffer (filling it with a solid color)
	{
		...
		const float clearColor[4] = { i_clearColor[0], i_clearColor[1], i_clearColor[2], i_clearColor[3] };
...
void eae6320::Graphics::cRenderTarget::SwapBuffer()
{
...
// Initialize / Clean Up
//--------------------------
eae6320::cResult eae6320::Graphics::cRenderTarget::Initialize(const sInitializationParameters& i_initializationParameters)
{
...
eae6320::cResult eae6320::Graphics::cRenderTarget::InitializeViews(const unsigned int i_resolutionWidth, const unsigned int i_resolutionHeight)
{
